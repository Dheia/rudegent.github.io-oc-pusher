...
# Database: db
# Generation Time: 2020-01-14 23:55:26 +0000
# ************************************************************
...
VALUES
	(1,'Owners','2019-11-24 23:18:27','2019-11-24 23:18:27','owners','Default group for website owners.',0);
...
VALUES
	(1,'Publisher','publisher','Site editor with access to publishing tools.','',1,'2019-11-24 23:18:27','2019-11-24 23:18:27'),
	(2,'Developer','developer','Site administrator with access to developer tools.','',1,'2019-11-24 23:18:27','2019-11-24 23:18:27');
...
VALUES
	(1,'Spotlayer','Team','spotlayer','support@spotlayer.com','$2y$10$NNuJRvqFga7oSURZHcRC4e.ZiEoWpp62DeQMGcneEW4aiMU8FJwYK',NULL,'$2y$10$le4amZ9CGODdXuLrXZAgKe/WqtRGO5G4U/uZNxCTzNTIWoN93gV9C',NULL,'',1,2,NULL,'2020-01-13 04:40:03','2019-11-24 23:18:28','2020-01-13 04:40:03',NULL,1);
...
# Dump of table jacob_logbook_logs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `jacob_logbook_logs`;
...
CREATE TABLE `jacob_logbook_logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `jacob_logbook_logs_model_index` (`model`),
  KEY `jacob_logbook_logs_model_key_index` (`model_key`),
  KEY `jacob_logbook_logs_updated_at_index` (`updated_at`),
  KEY `jacob_logbook_logs_backend_user_id_foreign` (`backend_user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
# Dump of table rainlab_location_countries
# ------------------------------------------------------------
...
INSERT INTO `rainlab_location_countries` (`id`, `is_enabled`, `name`, `code`, `is_pinned`)
VALUES
	(68,1,'Egypt','EG',1),
...
# Dump of table rainlab_location_states
# ------------------------------------------------------------
...
INSERT INTO `rainlab_location_states` (`id`, `country_id`, `name`, `code`)
VALUES
	(1,4,'Alabama','AL'),
	(2,4,'Alaska','AK'),
...
# Dump of table rainlab_notify_notification_rules
# ------------------------------------------------------------
...
INSERT INTO `rainlab_notify_notification_rules` (`id`, `name`, `code`, `class_name`, `description`, `config_data`, `condition_data`, `is_enabled`, `is_custom`, `created_at`, `updated_at`)
VALUES
	(1,'Send welcome email to user','welcome_email','RainLab\\User\\NotifyRules\\UserRegisteredEvent','',NULL,NULL,0,0,'2019-11-26 02:11:44','2020-01-14 16:21:03');

/*!40000 ALTER TABLE `rainlab_notify_notification_rules` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table rainlab_notify_notifications
# ------------------------------------------------------------
...
CREATE TABLE `rainlab_notify_notifications` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `rainlab_notify_notifications_notifiable_id_notifiable_type_index` (`notifiable_id`,`notifiable_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table rainlab_notify_rule_actions
# ------------------------------------------------------------
...
INSERT INTO `rainlab_notify_rule_actions` (`id`, `class_name`, `config_data`, `rule_host_id`, `created_at`, `updated_at`)
VALUES
	(1,'RainLab\\Notify\\NotifyRules\\SendMailTemplateAction','{\"mail_template\":\"rainlab.user::welcome\",\"send_to_mode\":\"user\"}',1,'2019-11-26 02:11:44','2019-11-26 02:11:44');

/*!40000 ALTER TABLE `rainlab_notify_rule_actions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table rainlab_notify_rule_conditions
# ------------------------------------------------------------
...
INSERT INTO `rainlab_notify_rule_conditions` (`id`, `class_name`, `config_data`, `condition_control_type`, `rule_host_type`, `rule_host_id`, `rule_parent_id`, `created_at`, `updated_at`)
VALUES
	(1,'RainLab\\Notify\\Classes\\CompoundCondition','{\"condition_type\":\"0\",\"condition\":\"true\"}',NULL,'any',1,NULL,'2020-01-14 16:20:58','2020-01-14 16:21:03');
...
INSERT INTO `rainlab_translate_attributes` (`id`, `locale`, `model_id`, `model_type`, `attribute_data`)
VALUES
...
CREATE TABLE `rainlab_translate_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `rainlab_translate_messages_code_index` (`code`(191))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `rainlab_translate_messages` WRITE;
/*!40000 ALTER TABLE `rainlab_translate_messages` DISABLE KEYS */;

INSERT INTO `rainlab_translate_messages` (`id`, `code`, `message_data`)
VALUES
...
# Dump of table responsiv_currency_currencies
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_currency_currencies`;
...
CREATE TABLE `responsiv_currency_currencies` (
  ...
  PRIMARY KEY (`id`),
  KEY `responsiv_currency_currencies_currency_code_index` (`currency_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `responsiv_currency_currencies` WRITE;
/*!40000 ALTER TABLE `responsiv_currency_currencies` DISABLE KEYS */;

INSERT INTO `responsiv_currency_currencies` (`id`, `name`, `currency_code`, `currency_symbol`, `decimal_point`, `thousand_separator`, `place_symbol_before`, `with_space`, `is_enabled`, `is_primary`, `created_at`, `updated_at`, `initbiz_money_fraction_digits`)
VALUES
	(1,'U.S. Dollar','USD','$','.',',',1,0,1,1,NULL,NULL,2),
	(2,'Euro','EUR','€','.',',',1,0,1,0,NULL,NULL,NULL),
	(3,'Pound Sterling','GBP','£','.',',',1,0,1,0,NULL,NULL,2),
	(4,'Australian Dollar','AUD','$','.',',',1,0,1,0,NULL,NULL,NULL),
	(5,'جنيه مصري','EGP','ج.م.','.',',',0,1,1,0,NULL,'2019-11-25 21:40:06',2);

/*!40000 ALTER TABLE `responsiv_currency_currencies` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table responsiv_currency_exchange_converters
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_currency_exchange_converters`;
...
# Dump of table responsiv_currency_exchange_rates
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_currency_exchange_rates`;
...
# Dump of table responsiv_pay_invoice_items
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_invoice_items`;
...
CREATE TABLE `responsiv_pay_invoice_items` (
  ...
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_invoice_items_invoice_id_index` (`invoice_id`),
  KEY `responsiv_pay_invoice_items_tax_class_id_index` (`tax_class_id`),
  KEY `responsiv_pay_invoice_items_related_id_index` (`related_id`),
  KEY `responsiv_pay_invoice_items_related_type_index` (`related_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table responsiv_pay_invoice_logs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_invoice_logs`;
...
CREATE TABLE `responsiv_pay_invoice_logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_invoice_logs_invoice_id_index` (`invoice_id`),
  KEY `responsiv_pay_invoice_logs_admin_id_index` (`admin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table responsiv_pay_invoice_status_logs
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_invoice_status_logs`;
...
CREATE TABLE `responsiv_pay_invoice_status_logs` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_invoice_status_logs_invoice_id_index` (`invoice_id`),
  KEY `responsiv_pay_invoice_status_logs_status_id_index` (`status_id`),
  KEY `responsiv_pay_invoice_status_logs_admin_id_index` (`admin_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table responsiv_pay_invoice_statuses
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_invoice_statuses`;
...
CREATE TABLE `responsiv_pay_invoice_statuses` (
  ...
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_invoice_statuses_code_index` (`code`),
  KEY `responsiv_pay_invoice_statuses_notify_template_index` (`notify_template`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `responsiv_pay_invoice_statuses` WRITE;
/*!40000 ALTER TABLE `responsiv_pay_invoice_statuses` DISABLE KEYS */;

INSERT INTO `responsiv_pay_invoice_statuses` (`id`, `name`, `code`, `is_enabled`, `notify_user`, `notify_template`)
VALUES
...
/*!40000 ALTER TABLE `responsiv_pay_invoice_statuses` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table responsiv_pay_invoice_templates
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_invoice_templates`;
...
CREATE TABLE `responsiv_pay_invoices` (
  ...
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_invoices_template_id_index` (`template_id`),
  KEY `responsiv_pay_invoices_user_id_index` (`user_id`),
  KEY `responsiv_pay_invoices_state_id_index` (`state_id`),
  KEY `responsiv_pay_invoices_country_id_index` (`country_id`),
  KEY `responsiv_pay_invoices_payment_method_id_index` (`payment_method_id`),
  KEY `responsiv_pay_invoices_status_id_index` (`status_id`),
  KEY `responsiv_pay_invoices_hash_index` (`hash`),
  KEY `responsiv_pay_invoices_related_id_index` (`related_id`),
  KEY `responsiv_pay_invoices_related_type_index` (`related_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table responsiv_pay_methods
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_methods`;
...
CREATE TABLE `responsiv_pay_methods` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_methods_code_index` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table responsiv_pay_methods_countries
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_methods_countries`;
...
# Dump of table responsiv_pay_taxes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_taxes`;
...
# Dump of table responsiv_pay_user_profiles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `responsiv_pay_user_profiles`;
...
CREATE TABLE `responsiv_pay_user_profiles` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `responsiv_pay_user_profiles_user_id_index` (`user_id`),
  KEY `responsiv_pay_user_profiles_payment_method_id_index` (`payment_method_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
# Dump of table spot_shipment_activity
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_activity`;
...
# Dump of table spot_shipment_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_address`;
...
# Dump of table spot_shipment_area
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_area`;
...
LOCK TABLES `spot_shipment_area` WRITE;
/*!40000 ALTER TABLE `spot_shipment_area` DISABLE KEYS */;

INSERT INTO `spot_shipment_area` (`id`, `city_id`, `name`)
VALUES
	(1,8,'Downtown Miami'),
	(2,8,'Key Biscayne');

/*!40000 ALTER TABLE `spot_shipment_area` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_car
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_car`;
...
# Dump of table spot_shipment_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_category`;
...
# Dump of table spot_shipment_city
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_city`;
...
LOCK TABLES `spot_shipment_city` WRITE;
/*!40000 ALTER TABLE `spot_shipment_city` DISABLE KEYS */;

INSERT INTO `spot_shipment_city` (`id`, `state_id`, `name`)
VALUES
	(1,637,'6 October'),
...
/*!40000 ALTER TABLE `spot_shipment_city` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_courier
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_courier`;
...
# Dump of table spot_shipment_delivery_time
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_delivery_time`;
...
LOCK TABLES `spot_shipment_delivery_time` WRITE;
/*!40000 ALTER TABLE `spot_shipment_delivery_time` DISABLE KEYS */;

INSERT INTO `spot_shipment_delivery_time` (`id`, `name`, `count`)
VALUES
	(1,'1-2 Days',48),
	(2,'2-3 Days',NULL);

/*!40000 ALTER TABLE `spot_shipment_delivery_time` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_employee_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_employee_order`;
...
# Dump of table spot_shipment_fees
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_fees`;
...
LOCK TABLES `spot_shipment_fees` WRITE;
/*!40000 ALTER TABLE `spot_shipment_fees` DISABLE KEYS */;

INSERT INTO `spot_shipment_fees` (`id`, `type`, `from`, `to`, `pickup_cost`, `delivery_cost`, `delivery_cost_back_sender`, `delivery_cost_back_receiver`, `back_cost_without_delivery_cost`, `back_cost_sender`, `back_cost_receiver`, `partial_back_cost`, `packaging`, `packaging_fees`)
VALUES
...
/*!40000 ALTER TABLE `spot_shipment_fees` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_item`;
...
# Dump of table spot_shipment_manifest
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_manifest`;
...
# Dump of table spot_shipment_mode
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_mode`;
...
# Dump of table spot_shipment_notes
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_notes`;
...
# Dump of table spot_shipment_office
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_office`;
...
# Dump of table spot_shipment_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_order`;
...
CREATE TABLE `spot_shipment_order` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `spot_shipment_order_barcode_unique` (`barcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;



# Dump of table spot_shipment_packaging
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_packaging`;
...
LOCK TABLES `spot_shipment_packaging` WRITE;
/*!40000 ALTER TABLE `spot_shipment_packaging` DISABLE KEYS */;

INSERT INTO `spot_shipment_packaging` (`id`, `name`, `description`)
VALUES
...
/*!40000 ALTER TABLE `spot_shipment_packaging` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_payment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_payment`;
...
# Dump of table spot_shipment_status
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_status`;
...
LOCK TABLES `spot_shipment_status` WRITE;
/*!40000 ALTER TABLE `spot_shipment_status` DISABLE KEYS */;

INSERT INTO `spot_shipment_status` (`id`, `name`, `description`, `color`, `equal`)
VALUES
	(1,'Pending','','warning',0),
...
/*!40000 ALTER TABLE `spot_shipment_status` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_shipment_task
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_task`;
...
# Dump of table spot_shipment_tracking
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_tracking`;
...
# Dump of table spot_shipment_treasury
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_shipment_treasury`;
...
LOCK TABLES `spot_shipment_treasury` WRITE;
/*!40000 ALTER TABLE `spot_shipment_treasury` DISABLE KEYS */;

INSERT INTO `spot_shipment_treasury` (`id`, `default`, `office_id`, `name`, `balance`, `created_at`, `updated_at`, `deleted_at`)
VALUES
	(1,1,NULL,'Main',240.00,'2019-11-25 00:07:20','2019-11-27 21:03:13',NULL);

/*!40000 ALTER TABLE `spot_shipment_treasury` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_userpermissions_group_permission
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_userpermissions_group_permission`;
...
# Dump of table spot_userpermissions_permissions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_userpermissions_permissions`;
...
CREATE TABLE `spot_userpermissions_permissions` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `spot_userpermissions_permissions_code_unique` (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

LOCK TABLES `spot_userpermissions_permissions` WRITE;
/*!40000 ALTER TABLE `spot_userpermissions_permissions` DISABLE KEYS */;

INSERT INTO `spot_userpermissions_permissions` (`id`, `code`, `name`, `description`, `created_at`, `updated_at`, `type`)
VALUES
	(1,'order','Workorder','Ability to manage the work orders','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(2,'setting','Setting','Ability to manage system configuration','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(3,'languages','Languages','Ability to manage lanaguages','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(4,'departments','Departments','Ability to manage departments/groups','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(5,'employees','Employees','Ability to manage employees','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(6,'backups','Backups','Ability to manage backups','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(7,'manifest','Manifest','Ability to manage manifest','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(8,'assign','Assign','Ability to assign employees and drivers to orders','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(9,'client','Client','Ability to manage clients','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(10,'statuses','Statuses','Ability to manage statuses','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(11,'areas','Areas','Ability to manage areas','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(12,'fees','Fees','Ability to manage fees','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(13,'currencies','Currencies','Ability to manage currencies','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(14,'packaging','Packaging','Ability to manage packaging','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(15,'countries','Countries','Ability to manage countries','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(16,'states','States','Ability to manage states','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(17,'cities','Cities','Ability to manage cities','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(18,'branches','Branches','Ability to manage branches','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(19,'cars','Cars','Ability to manage cars','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(20,'transaction','Transactions','Ability to manage transactions','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(21,'report','Reports','Ability to manage reports','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(22,'message','Messages','Ability to manage client messages','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(23,'category','Category','Ability to manage products categories','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(24,'couriers','Couriers','Ability to manage couriers','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(25,'shipping','Shipping','Ability to manage shipping modes','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(26,'treasury','Treasury','Ability to manage treasury','2019-11-24 11:42:01','2019-11-24 11:42:01','crud'),
	(27,'deliverytimes','Delivery Times','Ability to manage delivery times','2019-11-24 11:42:01','2019-11-24 11:42:01','crud');

/*!40000 ALTER TABLE `spot_userpermissions_permissions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table spot_userpermissions_user_permission
# ------------------------------------------------------------

DROP TABLE IF EXISTS `spot_userpermissions_user_permission`;
...
LOCK TABLES `spot_userpermissions_user_permission` WRITE;
/*!40000 ALTER TABLE `spot_userpermissions_user_permission` DISABLE KEYS */;

INSERT INTO `spot_userpermissions_user_permission` (`user_id`, `permission_id`, `permission_state`, `created_at`, `updated_at`)
VALUES
	(1,1,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,2,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,3,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,4,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,5,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,6,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,7,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,8,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,9,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,10,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,11,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,12,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,13,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,14,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,15,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,16,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,17,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,18,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,19,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,20,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,21,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,22,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,23,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,24,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,25,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,26,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01'),
	(1,27,'crud','2019-11-24 23:42:01','2019-11-24 23:42:01');

/*!40000 ALTER TABLE `spot_userpermissions_user_permission` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	(8,'5ddd8a3f510a5987313209.jpg','1 (1).jpg',51571,'image/jpeg',NULL,NULL,'id_copy','2','Spot\\Shipment\\Models\\Order',1,8,'2019-11-27 01:25:35','2019-11-27 01:25:35'),
	(9,'5dde2cd311700857850857.jpg','id-identification-driver-license-national-260nw-1310800595 (1).jpg',21410,'image/jpeg',NULL,NULL,'id_copy','1','Spot\\Shipment\\Models\\Order',1,9,'2019-11-27 12:59:15','2019-11-27 12:59:15'),
	(10,'5dde9d7615bb9455148432.jpg','cam-1574870333083.jpg',8003,'image/jpeg',NULL,NULL,'id_copy','3','Spot\\Shipment\\Models\\Order',1,10,'2019-11-27 20:59:50','2019-11-27 20:59:50'),
	(12,'5e190d2819c42114498074.png','1.png',43431,'image/png',NULL,NULL,'id_copy','5','Spot\\Shipment\\Models\\Order',1,12,'2020-01-10 21:47:52','2020-01-10 21:47:52');
...
VALUES
	(1,'zainab.simplecontact::mail.reply',NULL,NULL,NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(2,'zainab.simplecontact::mail.auto-response',NULL,NULL,NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(3,'zainab.simplecontact::mail.notification',NULL,NULL,NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(4,'rainlab.user::mail.activate',NULL,'Activate a new user',NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(5,'rainlab.user::mail.welcome',NULL,'User confirmed their account',NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(6,'rainlab.user::mail.restore',NULL,'User requests a password reset',NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(7,'rainlab.user::mail.new_user',NULL,'Notify admins of a new sign up',NULL,NULL,2,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(8,'rainlab.user::mail.reactivate',NULL,'User has reactivated their account',NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(9,'rainlab.user::mail.invite',NULL,'Invite a new user to the website',NULL,NULL,1,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(10,'backend::mail.invite',NULL,'Invite new admin to the site',NULL,NULL,2,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(11,'backend::mail.restore',NULL,'Reset an admin password',NULL,NULL,2,0,'2019-11-26 20:28:37','2019-11-26 20:28:37'),
	(13,'notification','Notification','The default Template for Notification','<p>{{theme_lang.dear}} <strong>{{ name }}</strong>,</p>\r\n{% if content %}\r\n<p>\r\n    {{content}}\r\n</p>\r\n{% endif %}\r\n{% if link %}\r\n<p>\r\n    <a href=\"{{ link }}\">{{ link }}</a>\r\n</p>\r\n{% endif %}','',3,1,'2019-11-26 20:32:43','2019-11-26 20:32:43');
...
VALUES
	(2,'RainLab.User','script','1.0.1','create_users_table.php','2019-11-24 23:38:38'),
	(3,'RainLab.User','script','1.0.1','create_throttle_table.php','2019-11-24 23:38:39'),
	(4,'RainLab.User','comment','1.0.1','Initialize plugin.','2019-11-24 23:38:39'),
	(5,'RainLab.User','comment','1.0.2','Seed tables.','2019-11-24 23:38:39'),
	(6,'RainLab.User','comment','1.0.3','Translated hard-coded text to language strings.','2019-11-24 23:38:39'),
	(7,'RainLab.User','comment','1.0.4','Improvements to user-interface for Location manager.','2019-11-24 23:38:39'),
	(8,'RainLab.User','comment','1.0.5','Added contact details for users.','2019-11-24 23:38:39'),
	(9,'RainLab.User','script','1.0.6','create_mail_blockers_table.php','2019-11-24 23:38:39'),
	(10,'RainLab.User','comment','1.0.6','Added Mail Blocker utility so users can block specific mail templates.','2019-11-24 23:38:39'),
	(11,'RainLab.User','comment','1.0.7','Add back-end Settings page.','2019-11-24 23:38:39'),
	(12,'RainLab.User','comment','1.0.8','Updated the Settings page.','2019-11-24 23:38:39'),
	(13,'RainLab.User','comment','1.0.9','Adds new welcome mail message for users and administrators.','2019-11-24 23:38:39'),
	(14,'RainLab.User','comment','1.0.10','Adds administrator-only activation mode.','2019-11-24 23:38:39'),
	(15,'RainLab.User','script','1.0.11','users_add_login_column.php','2019-11-24 23:38:39'),
	(16,'RainLab.User','comment','1.0.11','Users now have an optional login field that defaults to the email field.','2019-11-24 23:38:39'),
	(17,'RainLab.User','script','1.0.12','users_rename_login_to_username.php','2019-11-24 23:38:39'),
	(18,'RainLab.User','comment','1.0.12','Create a dedicated setting for choosing the login mode.','2019-11-24 23:38:39'),
	(19,'RainLab.User','comment','1.0.13','Minor fix to the Account sign in logic.','2019-11-24 23:38:39'),
	(20,'RainLab.User','comment','1.0.14','Minor improvements to the code.','2019-11-24 23:38:39'),
	(21,'RainLab.User','script','1.0.15','users_add_surname.php','2019-11-24 23:38:39'),
	(22,'RainLab.User','comment','1.0.15','Adds last name column to users table (surname).','2019-11-24 23:38:39'),
	(23,'RainLab.User','comment','1.0.16','Require permissions for settings page too.','2019-11-24 23:38:39'),
	(24,'RainLab.User','comment','1.1.0','!!! Profile fields and Locations have been removed.','2019-11-24 23:38:39'),
	(25,'RainLab.User','script','1.1.1','create_user_groups_table.php','2019-11-24 23:38:39'),
	(26,'RainLab.User','script','1.1.1','seed_user_groups_table.php','2019-11-24 23:38:39'),
	(27,'RainLab.User','comment','1.1.1','Users can now be added to groups.','2019-11-24 23:38:39'),
	(28,'RainLab.User','comment','1.1.2','A raw URL can now be passed as the redirect property in the Account component.','2019-11-24 23:38:39'),
	(29,'RainLab.User','comment','1.1.3','Adds a super user flag to the users table, reserved for future use.','2019-11-24 23:38:39'),
	(30,'RainLab.User','comment','1.1.4','User list can be filtered by the group they belong to.','2019-11-24 23:38:39'),
	(31,'RainLab.User','comment','1.1.5','Adds a new permission to hide the User settings menu item.','2019-11-24 23:38:39'),
	(32,'RainLab.User','script','1.2.0','users_add_deleted_at.php','2019-11-24 23:38:39'),
	(33,'RainLab.User','comment','1.2.0','Users can now deactivate their own accounts.','2019-11-24 23:38:39'),
	(34,'RainLab.User','comment','1.2.1','New feature for checking if a user is recently active/online.','2019-11-24 23:38:39'),
	(35,'RainLab.User','comment','1.2.2','Add bulk action button to user list.','2019-11-24 23:38:39'),
	(36,'RainLab.User','comment','1.2.3','Included some descriptive paragraphs in the Reset Password component markup.','2019-11-24 23:38:39'),
	(37,'RainLab.User','comment','1.2.4','Added a checkbox for blocking all mail sent to the user.','2019-11-24 23:38:39'),
	(38,'RainLab.User','script','1.2.5','update_timestamp_nullable.php','2019-11-24 23:38:39'),
	(39,'RainLab.User','comment','1.2.5','Database maintenance. Updated all timestamp columns to be nullable.','2019-11-24 23:38:39'),
	(40,'RainLab.User','script','1.2.6','users_add_last_seen.php','2019-11-24 23:38:39'),
	(41,'RainLab.User','comment','1.2.6','Add a dedicated last seen column for users.','2019-11-24 23:38:39'),
	(42,'RainLab.User','comment','1.2.7','Minor fix to user timestamp attributes.','2019-11-24 23:38:39'),
	(43,'RainLab.User','comment','1.2.8','Add date range filter to users list. Introduced a logout event.','2019-11-24 23:38:39'),
	(44,'RainLab.User','comment','1.2.9','Add invitation mail for new accounts created in the back-end.','2019-11-24 23:38:39'),
	(45,'RainLab.User','script','1.3.0','users_add_guest_flag.php','2019-11-24 23:38:39'),
	(46,'RainLab.User','script','1.3.0','users_add_superuser_flag.php','2019-11-24 23:38:39'),
	(47,'RainLab.User','comment','1.3.0','Introduced guest user accounts.','2019-11-24 23:38:39'),
	(48,'RainLab.User','comment','1.3.1','User notification variables can now be extended.','2019-11-24 23:38:39'),
	(49,'RainLab.User','comment','1.3.2','Minor fix to the Auth::register method.','2019-11-24 23:38:39'),
	(50,'RainLab.User','comment','1.3.3','Allow prevention of concurrent user sessions via the user settings.','2019-11-24 23:38:39'),
	(51,'RainLab.User','comment','1.3.4','Added force secure protocol property to the account component.','2019-11-24 23:38:39'),
	(52,'RainLab.User','comment','1.4.0','!!! The Notifications tab in User settings has been removed.','2019-11-24 23:38:39'),
	(53,'RainLab.User','comment','1.4.1','Added support for user impersonation.','2019-11-24 23:38:39'),
	(54,'RainLab.User','comment','1.4.2','Fixes security bug in Password Reset component.','2019-11-24 23:38:39'),
	(55,'RainLab.User','comment','1.4.3','Fixes session handling for AJAX requests.','2019-11-24 23:38:39'),
	(56,'RainLab.User','comment','1.4.4','Fixes bug where impersonation touches the last seen timestamp.','2019-11-24 23:38:39'),
	(57,'RainLab.User','comment','1.4.5','Added token fallback process to Account / Reset Password components when parameter is missing.','2019-11-24 23:38:39'),
	(58,'RainLab.User','comment','1.4.6','Fixes Auth::register method signature mismatch with core OctoberCMS Auth library','2019-11-24 23:38:39'),
	(59,'RainLab.User','comment','1.4.7','Fixes redirect bug in Account component / Update translations and separate user and group management.','2019-11-24 23:38:39'),
	(60,'RainLab.User','comment','1.4.8','Fixes a bug where calling MailBlocker::removeBlock could remove all mail blocks for the user.','2019-11-24 23:38:39'),
	(61,'RainLab.User','comment','1.5.0','!!! Required password length is now a minimum of 8 characters. Previous passwords will not be affected until the next password change.','2019-11-24 23:38:39'),
	(62,'Vdomah.JWTAuth','comment','1.0.0','Initialize plugin.','2019-11-24 23:38:50'),
	(63,'Vdomah.JWTAuth','comment','1.0.1','Custom service provider and config file added.','2019-11-24 23:38:50'),
	(64,'Vdomah.JWTAuth','comment','1.0.2','Compability with OctoberCMS builds > 419 (Laravel 5.5)','2019-11-24 23:38:50'),
	(65,'Vdomah.JWTAuth','comment','1.0.3','README.md updated','2019-11-24 23:38:50'),
	(66,'Vdomah.JWTAuth','comment','1.0.4','Ability to define own set of user attributes in response.','2019-11-24 23:38:50'),
	(67,'Vdomah.JWTAuth','comment','1.0.5','/refresh and /invalidate endpoints back.','2019-11-24 23:38:50'),
	(68,'Vdomah.JWTAuth','comment','1.0.6','Update README about creating route in another plugin.','2019-11-24 23:38:50'),
	(69,'Vdomah.JWTAuth','comment','1.0.7','Compability with OctoberCMS builds > 454 (Authenticatable trait removed)','2019-11-24 23:38:50'),
	(70,'RainLab.Notify','script','1.0.1','create_notifications_table.php','2019-11-24 23:38:58'),
	(71,'RainLab.Notify','script','1.0.1','create_notification_rules_table.php','2019-11-24 23:38:58'),
	(72,'RainLab.Notify','script','1.0.1','create_rule_conditions_table.php','2019-11-24 23:38:58'),
	(73,'RainLab.Notify','script','1.0.1','create_rule_actions_table.php','2019-11-24 23:38:58'),
	(74,'RainLab.Notify','comment','1.0.1','First version of Notify','2019-11-24 23:38:58'),
	(75,'RainLab.Notify','comment','1.0.2','Fixes crashing bug.','2019-11-24 23:38:58'),
	(76,'Tiipiik.SmsSender','script','1.0.1','create_message_histories_table.php','2019-11-24 23:39:11'),
	(77,'Tiipiik.SmsSender','comment','1.0.1','First version of SmsSender','2019-11-24 23:39:11'),
	(78,'Tiipiik.SmsSender','comment','1.0.2','Added russian localisation, PR by @maximlit. Thanks !','2019-11-24 23:39:11'),
	(79,'Tiipiik.SmsSender','comment','1.0.3','Added Dutch language, thanks to @dogiedog','2019-11-24 23:39:11'),
	(80,'Tiipiik.SmsSender','comment','1.0.4','Added Dutch translation, thanks to @alacoo','2019-11-24 23:39:11'),
	(81,'RainLab.Location','comment','1.0.1','Initialize plugin.','2019-11-24 23:39:19'),
	(82,'RainLab.Location','script','1.0.2','create_states_table.php','2019-11-24 23:39:19'),
	(83,'RainLab.Location','script','1.0.2','create_countries_table.php','2019-11-24 23:39:19'),
	(84,'RainLab.Location','comment','1.0.2','Create database tables.','2019-11-24 23:39:19'),
	(85,'RainLab.Location','script','1.0.3','seed_all_tables.php','2019-11-24 23:39:20'),
	(86,'RainLab.Location','comment','1.0.3','Add seed data for countries and states.','2019-11-24 23:39:20'),
	(87,'RainLab.Location','comment','1.0.4','Satisfy the new Google API key requirement.','2019-11-24 23:39:20'),
	(88,'RainLab.Location','script','1.0.5','add_country_pinned_flag.php','2019-11-24 23:39:20'),
	(89,'RainLab.Location','comment','1.0.5','Countries can now be pinned to make them appear at the top of the list.','2019-11-24 23:39:20'),
	(90,'RainLab.Location','comment','1.0.6','Added support for defining a default country and state.','2019-11-24 23:39:20'),
	(91,'RainLab.Location','comment','1.0.7','Added basic geocoding method to the Country model.','2019-11-24 23:39:20'),
	(92,'RainLab.Location','comment','1.0.8','Include Mexico states','2019-11-24 23:39:20'),
	(93,'RainLab.Location','comment','1.1.0','!!! Update requires Build 447. Fixed AddressFinder formwidget not working correctly in repeaters.','2019-11-24 23:39:20'),
	(94,'RainLab.Location','comment','1.1.1','Minor fix to AddressFinder formwidget for the change to the FormField API','2019-11-24 23:39:20'),
	(95,'RainLab.Location','comment','1.1.2','Yet another change to the AddressFinder for changes to the FormField API','2019-11-24 23:39:20'),
	(96,'RainLab.Location','script','1.1.3','seed_ar_states.php','2019-11-24 23:39:20'),
	(97,'RainLab.Location','comment','1.1.3','Include Argentina states','2019-11-24 23:39:20'),
	(98,'RainLab.Location','comment','1.1.4','Added support for UK counties','2019-11-24 23:39:20'),
	(99,'RainLab.Location','script','1.1.5','seed_it_states.php','2019-11-24 23:39:20'),
	(100,'RainLab.Location','comment','1.1.5','Include Italian states (province)','2019-11-24 23:39:20'),
	(101,'RainLab.UserPlus','comment','1.0.1','First version of User Profile','2019-11-24 23:39:29'),
	(102,'RainLab.UserPlus','script','1.0.2','user_add_profile_fields.php','2019-11-24 23:39:29'),
	(103,'RainLab.UserPlus','script','1.0.2','user_add_location_fields.php','2019-11-24 23:39:29'),
	(104,'RainLab.UserPlus','comment','1.0.2','Reintroduce profile fields that were removed from User plugin','2019-11-24 23:39:29'),
	(105,'RainLab.UserPlus','script','1.0.3','user_add_mobile_field.php','2019-11-24 23:39:29'),
	(106,'RainLab.UserPlus','comment','1.0.3','Add mobile phone user profile field.','2019-11-24 23:39:29'),
	(107,'RainLab.UserPlus','comment','1.0.4','Add various languages and minor bug fixes.','2019-11-24 23:39:29'),
	(108,'RainLab.UserPlus','comment','1.1.0','Compatibility with Notify plugin.','2019-11-24 23:39:29'),
	(109,'Vdomah.Roles','script','1.0.0','builder_table_create_vdomah_roles_roles.php','2019-11-24 23:39:37'),
	(110,'Vdomah.Roles','script','1.0.0','builder_table_create_vdomah_roles_permissions.php','2019-11-24 23:39:37'),
	(111,'Vdomah.Roles','script','1.0.0','users_add_role_id_column.php','2019-11-24 23:39:37'),
	(112,'Vdomah.Roles','comment','1.0.0','Initialize plugin.','2019-11-24 23:39:37'),
	(113,'Vdomah.Roles','comment','1.0.1','Permission name transaltable. Readme update. Move static methods to Helper','2019-11-24 23:39:37'),
	(114,'Vdomah.Roles','comment','1.0.2','Soft implementation of RainLab.Translate','2019-11-24 23:39:37'),
	(115,'Vdomah.Roles','comment','1.0.3','SimpleTree trait implemented, fixed roles dropdown in user form','2019-11-24 23:39:38'),
	(116,'Vdomah.Roles','comment','1.0.4','Replaced hardcoded backend urls with dynamic links in view (thanks to Damian Verhaar)','2019-11-24 23:39:38'),
	(117,'Vdomah.Roles','comment','1.0.5','Replaced hardcoded backend urls with dynamic links in controller (thanks to Damian Verhaar)','2019-11-24 23:39:38'),
	(118,'Vdomah.Roles','comment','1.1.0','CMS Pages access managment by assigning roles and permissions','2019-11-24 23:39:38'),
	(119,'Vdomah.Roles','comment','1.1.1','CMS Pages access managment moved to separate tab','2019-11-24 23:39:38'),
	(120,'Vdomah.Roles','comment','1.1.2','Fixed bug wich prevented returning the whole ancestor tree in a role (thanks Daniel Tamas). En translations updated','2019-11-24 23:39:38'),
	(121,'Vdomah.Roles','comment','1.1.3','\"Logged only\" CMS page parameter added','2019-11-24 23:39:38'),
	(122,'Vdomah.Roles','comment','1.2.0','Lovata.Buddies plugin integration','2019-11-24 23:39:38'),
	(123,'Vdomah.Roles','script','1.2.1','buddies_add_role_id_column.php','2019-11-24 23:39:38'),
	(124,'Vdomah.Roles','comment','1.2.1','Check if users table exists in migrations before altering it','2019-11-24 23:39:38'),
	(125,'Vdomah.Roles','comment','1.2.2','Add fillable to Role model','2019-11-24 23:39:38'),
	(126,'Vdomah.Roles','comment','1.2.3','role_id field nullable','2019-11-24 23:39:38'),
	(127,'Vdomah.Roles','comment','1.2.4','Check role_id exists in users table and add if no','2019-11-24 23:39:38'),
	(128,'Vdomah.Roles','comment','1.2.5','Added isRole and able methods to user object','2019-11-24 23:39:38'),
	(129,'RainLab.Translate','script','1.0.1','create_messages_table.php','2019-11-24 23:39:47'),
	(130,'RainLab.Translate','script','1.0.1','create_attributes_table.php','2019-11-24 23:39:47'),
	(131,'RainLab.Translate','script','1.0.1','create_locales_table.php','2019-11-24 23:39:47'),
	(132,'RainLab.Translate','comment','1.0.1','First version of Translate','2019-11-24 23:39:47'),
	(133,'RainLab.Translate','comment','1.0.2','Languages and Messages can now be deleted.','2019-11-24 23:39:47'),
	(134,'RainLab.Translate','comment','1.0.3','Minor updates for latest October release.','2019-11-24 23:39:47'),
	(135,'RainLab.Translate','comment','1.0.4','Locale cache will clear when updating a language.','2019-11-24 23:39:47'),
	(136,'RainLab.Translate','comment','1.0.5','Add Spanish language and fix plugin config.','2019-11-24 23:39:47'),
	(137,'RainLab.Translate','comment','1.0.6','Minor improvements to the code.','2019-11-24 23:39:47'),
	(138,'RainLab.Translate','comment','1.0.7','Fixes major bug where translations are skipped entirely!','2019-11-24 23:39:47'),
	(139,'RainLab.Translate','comment','1.0.8','Minor bug fixes.','2019-11-24 23:39:47'),
	(140,'RainLab.Translate','comment','1.0.9','Fixes an issue where newly created models lose their translated values.','2019-11-24 23:39:47'),
	(141,'RainLab.Translate','comment','1.0.10','Minor fix for latest build.','2019-11-24 23:39:47'),
	(142,'RainLab.Translate','comment','1.0.11','Fix multilingual rich editor when used in stretch mode.','2019-11-24 23:39:47'),
	(143,'RainLab.Translate','comment','1.1.0','Introduce compatibility with RainLab.Pages plugin.','2019-11-24 23:39:47'),
	(144,'RainLab.Translate','comment','1.1.1','Minor UI fix to the language picker.','2019-11-24 23:39:47'),
	(145,'RainLab.Translate','comment','1.1.2','Add support for translating Static Content files.','2019-11-24 23:39:47'),
	(146,'RainLab.Translate','comment','1.1.3','Improved support for the multilingual rich editor.','2019-11-24 23:39:47'),
	(147,'RainLab.Translate','comment','1.1.4','Adds new multilingual markdown editor.','2019-11-24 23:39:47'),
	(148,'RainLab.Translate','comment','1.1.5','Minor update to the multilingual control API.','2019-11-24 23:39:47'),
	(149,'RainLab.Translate','comment','1.1.6','Minor improvements in the message editor.','2019-11-24 23:39:47'),
	(150,'RainLab.Translate','comment','1.1.7','Fixes bug not showing content when first loading multilingual textarea controls.','2019-11-24 23:39:47'),
	(151,'RainLab.Translate','comment','1.2.0','CMS pages now support translating the URL.','2019-11-24 23:39:47'),
	(152,'RainLab.Translate','comment','1.2.1','Minor update in the rich editor and code editor language control position.','2019-11-24 23:39:47'),
	(153,'RainLab.Translate','comment','1.2.2','Static Pages now support translating the URL.','2019-11-24 23:39:47'),
	(154,'RainLab.Translate','comment','1.2.3','Fixes Rich Editor when inserting a page link.','2019-11-24 23:39:47'),
	(155,'RainLab.Translate','script','1.2.4','create_indexes_table.php','2019-11-24 23:39:47'),
	(156,'RainLab.Translate','comment','1.2.4','Translatable attributes can now be declared as indexes.','2019-11-24 23:39:47'),
	(157,'RainLab.Translate','comment','1.2.5','Adds new multilingual repeater form widget.','2019-11-24 23:39:47'),
	(158,'RainLab.Translate','comment','1.2.6','Fixes repeater usage with static pages plugin.','2019-11-24 23:39:47'),
	(159,'RainLab.Translate','comment','1.2.7','Fixes placeholder usage with static pages plugin.','2019-11-24 23:39:47'),
	(160,'RainLab.Translate','comment','1.2.8','Improvements to code for latest October build compatibility.','2019-11-24 23:39:47'),
	(161,'RainLab.Translate','comment','1.2.9','Fixes context for translated strings when used with Static Pages.','2019-11-24 23:39:47'),
	(162,'RainLab.Translate','comment','1.2.10','Minor UI fix to the multilingual repeater.','2019-11-24 23:39:47'),
	(163,'RainLab.Translate','comment','1.2.11','Fixes translation not working with partials loaded via AJAX.','2019-11-24 23:39:47'),
	(164,'RainLab.Translate','comment','1.2.12','Add support for translating the new grouped repeater feature.','2019-11-24 23:39:47'),
	(165,'RainLab.Translate','comment','1.3.0','Added search to the translate messages page.','2019-11-24 23:39:47'),
	(166,'RainLab.Translate','script','1.3.1','builder_table_update_rainlab_translate_locales.php','2019-11-24 23:39:47'),
	(167,'RainLab.Translate','script','1.3.1','seed_all_tables.php','2019-11-24 23:39:47'),
	(168,'RainLab.Translate','comment','1.3.1','Added reordering to languages','2019-11-24 23:39:47'),
	(169,'RainLab.Translate','comment','1.3.2','Improved compatibility with RainLab.Pages, added ability to scan Mail Messages for translatable variables.','2019-11-24 23:39:47'),
	(170,'RainLab.Translate','comment','1.3.3','Fix to the locale picker session handling in Build 420 onwards.','2019-11-24 23:39:47'),
	(171,'RainLab.Translate','comment','1.3.4','Add alternate hreflang elements and adds prefixDefaultLocale setting.','2019-11-24 23:39:47'),
	(172,'RainLab.Translate','comment','1.3.5','Fix MLRepeater bug when switching locales.','2019-11-24 23:39:47'),
	(173,'RainLab.Translate','comment','1.3.6','Fix Middleware to use the prefixDefaultLocale setting introduced in 1.3.4','2019-11-24 23:39:47'),
	(174,'RainLab.Translate','comment','1.3.7','Fix config reference in LocaleMiddleware','2019-11-24 23:39:47'),
	(175,'RainLab.Translate','comment','1.3.8','Keep query string when switching locales','2019-11-24 23:39:47'),
	(176,'RainLab.Translate','comment','1.4.0','Add importer and exporter for messages','2019-11-24 23:39:47'),
	(177,'RainLab.Translate','comment','1.4.1','Updated Hungarian translation. Added Arabic translation. Fixed issue where default texts are overwritten by import. Fixed issue where the language switcher for repeater fields would overlap with the first repeater row.','2019-11-24 23:39:47'),
	(178,'RainLab.Translate','comment','1.4.2','Add multilingual MediaFinder','2019-11-24 23:39:47'),
	(179,'RainLab.Translate','comment','1.4.3','!!! Please update OctoberCMS to Build 444 before updating this plugin. Added ability to translate CMS Pages fields (e.g. title, description, meta-title, meta-description)','2019-11-24 23:39:47'),
	(180,'RainLab.Translate','comment','1.4.4','Minor improvements to compatibility with Laravel framework.','2019-11-24 23:39:47'),
	(181,'RainLab.Translate','comment','1.4.5','Fixed issue when using the language switcher','2019-11-24 23:39:47'),
	(182,'RainLab.Translate','comment','1.5.0','Compatibility fix with Build 451','2019-11-24 23:39:47'),
	(183,'RainLab.Translate','comment','1.6.0','Make File Upload widget properties translatable. Merge Repeater core changes into MLRepeater widget. Add getter method to retrieve original translate data.','2019-11-24 23:39:47'),
	(184,'RainLab.Translate','comment','1.6.1','Add ability for models to provide translated computed data, add option to disable locale prefix routing','2019-11-24 23:39:47'),
	(185,'RainLab.Translate','comment','1.6.2','Implement localeUrl filter, add per-locale theme configuration support','2019-11-24 23:39:47'),
	(186,'RainLab.Pages','comment','1.0.1','Implemented the static pages management and the Static Page component.','2019-11-24 23:40:05'),
	(187,'RainLab.Pages','comment','1.0.2','Fixed the page preview URL.','2019-11-24 23:40:05'),
	(188,'RainLab.Pages','comment','1.0.3','Implemented menus.','2019-11-24 23:40:05'),
	(189,'RainLab.Pages','comment','1.0.4','Implemented the content block management and placeholder support.','2019-11-24 23:40:05'),
	(190,'RainLab.Pages','comment','1.0.5','Added support for the Sitemap plugin.','2019-11-24 23:40:05'),
	(191,'RainLab.Pages','comment','1.0.6','Minor updates to the internal API.','2019-11-24 23:40:05'),
	(192,'RainLab.Pages','comment','1.0.7','Added the Snippets feature.','2019-11-24 23:40:05'),
	(193,'RainLab.Pages','comment','1.0.8','Minor improvements to the code.','2019-11-24 23:40:05'),
	(194,'RainLab.Pages','comment','1.0.9','Fixes issue where Snippet tab is missing from the Partials form.','2019-11-24 23:40:05'),
	(195,'RainLab.Pages','comment','1.0.10','Add translations for various locales.','2019-11-24 23:40:05'),
	(196,'RainLab.Pages','comment','1.0.11','Fixes issue where placeholders tabs were missing from Page form.','2019-11-24 23:40:05'),
	(197,'RainLab.Pages','comment','1.0.12','Implement Media Manager support.','2019-11-24 23:40:05'),
	(198,'RainLab.Pages','script','1.1.0','snippets_rename_viewbag_properties.php','2019-11-24 23:40:05'),
	(199,'RainLab.Pages','comment','1.1.0','Adds meta title and description to pages. Adds |staticPage filter.','2019-11-24 23:40:05'),
	(200,'RainLab.Pages','comment','1.1.1','Add support for Syntax Fields.','2019-11-24 23:40:05'),
	(201,'RainLab.Pages','comment','1.1.2','Static Breadcrumbs component now respects the hide from navigation setting.','2019-11-24 23:40:05'),
	(202,'RainLab.Pages','comment','1.1.3','Minor back-end styling fix.','2019-11-24 23:40:05'),
	(203,'RainLab.Pages','comment','1.1.4','Minor fix to the StaticPage component API.','2019-11-24 23:40:05'),
	(204,'RainLab.Pages','comment','1.1.5','Fixes bug when using syntax fields.','2019-11-24 23:40:05'),
	(205,'RainLab.Pages','comment','1.1.6','Minor styling fix to the back-end UI.','2019-11-24 23:40:05'),
	(206,'RainLab.Pages','comment','1.1.7','Improved menu item form to include CSS class, open in a new window and hidden flag.','2019-11-24 23:40:05'),
	(207,'RainLab.Pages','comment','1.1.8','Improved the output of snippet partials when saved.','2019-11-24 23:40:05'),
	(208,'RainLab.Pages','comment','1.1.9','Minor update to snippet inspector internal API.','2019-11-24 23:40:05'),
	(209,'RainLab.Pages','comment','1.1.10','Fixes a bug where selecting a layout causes permanent unsaved changes.','2019-11-24 23:40:05'),
	(210,'RainLab.Pages','comment','1.1.11','Add support for repeater syntax field.','2019-11-24 23:40:05'),
	(211,'RainLab.Pages','comment','1.2.0','Added support for translations, UI updates.','2019-11-24 23:40:05'),
	(212,'RainLab.Pages','comment','1.2.1','Use nice titles when listing the content files.','2019-11-24 23:40:05'),
	(213,'RainLab.Pages','comment','1.2.2','Minor styling update.','2019-11-24 23:40:05'),
	(214,'RainLab.Pages','comment','1.2.3','Snippets can now be moved by dragging them.','2019-11-24 23:40:05'),
	(215,'RainLab.Pages','comment','1.2.4','Fixes a bug where the cursor is misplaced when editing text files.','2019-11-24 23:40:05'),
	(216,'RainLab.Pages','comment','1.2.5','Fixes a bug where the parent page is lost upon changing a page layout.','2019-11-24 23:40:05'),
	(217,'RainLab.Pages','comment','1.2.6','Shared view variables are now passed to static pages.','2019-11-24 23:40:05'),
	(218,'RainLab.Pages','comment','1.2.7','Fixes issue with duplicating properties when adding multiple snippets on the same page.','2019-11-24 23:40:05'),
	(219,'RainLab.Pages','comment','1.2.8','Fixes a bug where creating a content block without extension doesn\'t save the contents to file.','2019-11-24 23:40:05'),
	(220,'RainLab.Pages','comment','1.2.9','Add conditional support for translating page URLs.','2019-11-24 23:40:05'),
	(221,'RainLab.Pages','comment','1.2.10','Streamline generation of URLs to use the new Cms::url helper.','2019-11-24 23:40:05'),
	(222,'RainLab.Pages','comment','1.2.11','Implements repeater usage with translate plugin.','2019-11-24 23:40:05'),
	(223,'RainLab.Pages','comment','1.2.12','Fixes minor issue when using snippets and switching the application locale.','2019-11-24 23:40:05'),
	(224,'RainLab.Pages','comment','1.2.13','Fixes bug when AJAX is used on a page that does not yet exist.','2019-11-24 23:40:05'),
	(225,'RainLab.Pages','comment','1.2.14','Add theme logging support for changes made to menus.','2019-11-24 23:40:05'),
	(226,'RainLab.Pages','comment','1.2.15','Back-end navigation sort order updated.','2019-11-24 23:40:05'),
	(227,'RainLab.Pages','comment','1.2.16','Fixes a bug when saving a template that has been modified outside of the CMS (mtime mismatch).','2019-11-24 23:40:05'),
	(228,'RainLab.Pages','comment','1.2.17','Changes locations of custom fields to secondary tabs instead of the primary Settings area. New menu search ability on adding menu items','2019-11-24 23:40:05'),
	(229,'RainLab.Pages','comment','1.2.18','Fixes cache-invalidation issues when RainLab.Translate is not installed. Added Greek & Simplified Chinese translations. Removed deprecated calls. Allowed saving HTML in snippet properties. Added support for the MediaFinder in menu items.','2019-11-24 23:40:05'),
	(230,'RainLab.Pages','comment','1.2.19','Catch exception with corrupted menu file.','2019-11-24 23:40:05'),
	(231,'RainLab.Pages','comment','1.2.20','StaticMenu component now exposes menuName property; added pages.menu.referencesGenerated event.','2019-11-24 23:40:05'),
	(232,'RainLab.Pages','comment','1.2.21','Fixes a bug where last Static Menu item cannot be deleted. Improved Persian, Slovak and Turkish translations.','2019-11-24 23:40:05'),
	(233,'RainLab.Pages','comment','1.3.0','Added support for using Database-driven Themes when enabled in the CMS configuration.','2019-11-24 23:40:05'),
	(234,'RainLab.Pages','comment','1.3.1','Added ChildPages Component, prevent hidden pages from being returned via menu item resolver.','2019-11-24 23:40:05'),
	(235,'PanaKour.Translate','comment','1.0.1','Initial version of translate plugin','2019-11-24 23:40:05'),
	(236,'PanaKour.Translate','comment','1.0.1','Make RainLab Static Menu Multilingual','2019-11-24 23:40:05'),
	(237,'Mey.Breadcrumbs','comment','1.0.1','First version of Breadcrumbs','2019-11-24 23:40:13'),
	(238,'Mey.Breadcrumbs','comment','1.0.2','Update how the menu works','2019-11-24 23:40:13'),
	(239,'Mey.Breadcrumbs','comment','1.0.3','Add the option to set the crumb title using a DOM element that lives on the page. This is helpful for pages that use :slug type routing.','2019-11-24 23:40:13'),
	(240,'Mey.Breadcrumbs','comment','1.0.4','Pages are now sorted by title in the dropdown menu in the breadcrumbs tab.','2019-11-24 23:40:13'),
	(241,'Mey.Breadcrumbs','comment','1.0.5','Update to fix the page sorting issue. Pages now sort alphabetically in the dropdown menu. Also a better icon choice.','2019-11-24 23:40:13'),
	(242,'Mey.Breadcrumbs','comment','1.0.6','Internal updates and bug fixes.','2019-11-24 23:40:13'),
	(243,'Mey.Breadcrumbs','comment','1.0.7','Bug fix for those who use element titles. Now no error will be thrown if the element does not exist on the page.','2019-11-24 23:40:13'),
	(244,'Mey.Breadcrumbs','comment','1.0.8','Updated menu to be much more logical. Also gave some more context to he menu dropdown.','2019-11-24 23:40:13'),
	(245,'Mey.Breadcrumbs','comment','1.0.9','Update to be compatible with the latest october build.','2019-11-24 23:40:13'),
	(246,'Mey.Breadcrumbs','comment','1.0.10','Fix for compatibility with 286 build.','2019-11-24 23:40:13'),
	(247,'Responsiv.Currency','script','1.0.1','create_exchange_converters_table.php','2019-11-24 23:40:22'),
	(248,'Responsiv.Currency','script','1.0.1','create_exchange_rates_table.php','2019-11-24 23:40:22'),
	(249,'Responsiv.Currency','script','1.0.1','create_currencies_table.php','2019-11-24 23:40:22'),
	(250,'Responsiv.Currency','script','1.0.1','seed_all_tables.php','2019-11-24 23:40:22'),
	(251,'Responsiv.Currency','comment','1.0.1','First version of Currency','2019-11-24 23:40:22'),
	(252,'Responsiv.Currency','comment','1.0.2','Add currency form widget and list column type.','2019-11-24 23:40:22'),
	(253,'Responsiv.Currency','comment','1.0.3','Add new exchanges Fixer and CoinMarketCap. Yahoo exchange has been discontinued.','2019-11-24 23:40:22'),
	(254,'Responsiv.Currency','comment','1.0.4','Improvements to currency formatting parameters.','2019-11-24 23:40:22'),
	(255,'Initbiz.Money','script','1.0.1','update_responsive_currency_currencies_table.php','2019-11-24 23:40:32'),
	(256,'Initbiz.Money','comment','1.0.1','Initialize plugin.','2019-11-24 23:40:32'),
	(257,'Initbiz.Money','comment','1.0.2','MoneyFields behavior fixed','2019-11-24 23:40:32'),
	(258,'Initbiz.Money','comment','1.0.3','Small extending fix for better DX','2019-11-24 23:40:32'),
	(259,'Initbiz.Money','comment','1.0.4','Minor bug fixes','2019-11-24 23:40:32'),
	(260,'Initbiz.Money','comment','1.0.5','Yet another small fix','2019-11-24 23:40:32'),
	(261,'Initbiz.Money','comment','1.0.6','Updating partials with moneyFields works','2019-11-24 23:40:32'),
	(262,'Initbiz.Money','comment','1.0.7','Added money column type','2019-11-24 23:40:32'),
	(263,'Initbiz.Money','comment','1.0.8','Minor bug fixes, a few features added','2019-11-24 23:40:32'),
	(264,'Responsiv.Uploader','comment','1.0.1','First version of Uploader','2019-11-24 23:40:40'),
	(265,'Jacob.Logbook','script','1.0.1','create_logs_table.php','2019-11-24 23:40:48'),
	(266,'Jacob.Logbook','comment','1.0.1','First version of Logbook','2019-11-24 23:40:48'),
	(267,'Jacob.Logbook','comment','1.0.2','Fix error when changing properties from the LogChanges trait.','2019-11-24 23:40:48'),
	(268,'Jacob.Logbook','comment','1.0.3','Add undo button to form widget and add report widget.','2019-11-24 23:40:48'),
	(269,'Excodus.TranslateExtended','comment','1.0.1','First version of Translate Extended','2019-11-24 23:40:56'),
	(270,'Excodus.TranslateExtended','comment','1.0.2','Added backend settings page with option to opt-out from the browser lang detection and route prefixing','2019-11-24 23:40:56'),
	(271,'Excodus.TranslateExtended','comment','1.0.2','Bug fixes','2019-11-24 23:40:56'),
	(272,'Excodus.TranslateExtended','comment','1.0.2','Improved browser language matching','2019-11-24 23:40:56'),
	(273,'Excodus.TranslateExtended','comment','1.0.3','Fixed default plugin settings','2019-11-24 23:40:56'),
	(274,'Excodus.TranslateExtended','comment','1.0.4','Added extended locale picker','2019-11-24 23:40:56'),
	(275,'Excodus.TranslateExtended','comment','1.0.5','Bug fixes','2019-11-24 23:40:56'),
	(276,'Excodus.TranslateExtended','comment','1.0.5','Added setting for homepage redirect','2019-11-24 23:40:56'),
	(277,'Excodus.TranslateExtended','comment','1.0.6','Support for translated page URLs','2019-11-24 23:40:56'),
	(278,'Excodus.TranslateExtended','comment','1.0.6','Fix for switcher for pages in subdirectory of domain','2019-11-24 23:40:56'),
	(279,'Excodus.TranslateExtended','comment','1.0.7','Specified \'web\' middleware for Laravel 5.5 support','2019-11-24 23:40:56'),
	(280,'Responsiv.Pay','script','1.0.1','create_invoices_table.php','2019-11-24 23:41:11'),
	(281,'Responsiv.Pay','script','1.0.1','create_methods_table.php','2019-11-24 23:41:11'),
	(282,'Responsiv.Pay','script','1.0.1','create_taxes_table.php','2019-11-24 23:41:11'),
	(283,'Responsiv.Pay','script','1.0.1','seed_all_tables.php','2019-11-24 23:41:11'),
	(284,'Responsiv.Pay','comment','1.0.1','First version of Pay','2019-11-24 23:41:11'),
	(285,'Responsiv.Pay','comment','1.0.2','Payment settings can now push the invoice number forward.','2019-11-24 23:41:11'),
	(286,'Responsiv.Pay','comment','1.0.3','Fixes bug in Skrill payment method when saving.','2019-11-24 23:41:11'),
	(287,'Responsiv.Pay','script','1.0.4','add_invoice_item_related.php','2019-11-24 23:41:11'),
	(288,'Responsiv.Pay','comment','1.0.4','Invoice items now support related objects.','2019-11-24 23:41:11'),
	(289,'Responsiv.Pay','script','1.1.0','create_user_profiles_table.php','2019-11-24 23:41:11'),
	(290,'Responsiv.Pay','comment','1.1.0','!!! Add support for payment profiles.','2019-11-24 23:41:11'),
	(291,'Responsiv.Pay','script','1.1.1','add_invoice_throwaway_flag.php','2019-11-24 23:41:11'),
	(292,'Responsiv.Pay','comment','1.1.1','Added a throwaway flag to invoices.','2019-11-24 23:41:11'),
	(293,'Zainab.SimpleContact','comment','1.0.1','Initialize plugin.','2019-11-24 23:41:20'),
	(294,'Zainab.SimpleContact','script','1.0.2','builder_table_create_zainab_simplecontact_contact.php','2019-11-24 23:41:20'),
	(295,'Zainab.SimpleContact','comment','1.0.2','Created table zainab_simplecontact_contact','2019-11-24 23:41:20'),
	(296,'Zainab.SimpleContact','script','1.0.3','builder_table_update_zainab_simplecontact_contact.php','2019-11-24 23:41:20'),
	(297,'Zainab.SimpleContact','comment','1.0.3','Updated table zainab_simplecontact_contact','2019-11-24 23:41:20'),
	(298,'Zainab.SimpleContact','comment','1.0.4','Change Alias bug fixed','2019-11-24 23:41:20'),
	(299,'Zainab.SimpleContact','comment','1.0.5','Dashboard widget added','2019-11-24 23:41:20'),
	(300,'Zainab.SimpleContact','comment','1.0.5','Language added -- Portuguese (Brazil)','2019-11-24 23:41:20'),
	(301,'Zainab.SimpleContact','comment','1.0.6','grecaptcha reset bug fixed','2019-11-24 23:41:20'),
	(302,'Zainab.SimpleContact','comment','1.1.0','sql_modes NO_ZERO_IN_DATE,NO_ZERO_DATE fixed','2019-11-24 23:41:20'),
	(303,'Zainab.SimpleContact','comment','1.1.0','minor bugs fixed','2019-11-24 23:41:20'),
	(304,'Zainab.SimpleContact','comment','1.1.1','Language added -- Russian','2019-11-24 23:41:20'),
	(305,'Zainab.SimpleContact','comment','1.1.1','minor bug fixed','2019-11-24 23:41:20'),
	(306,'Zainab.SimpleContact','comment','2.0.0','Translate Plugin Dependency Added (RainLab.Translate)','2019-11-24 23:41:20'),
	(307,'Zainab.SimpleContact','comment','2.0.0','Languages Added (Arabic, Chinese)','2019-11-24 23:41:20'),
	(308,'Zainab.SimpleContact','comment','2.0.1','Migration Bug Fixed','2019-11-24 23:41:20'),
	(309,'Zainab.SimpleContact','comment','2.0.1','Notification Email Updated','2019-11-24 23:41:20'),
	(310,'Zainab.SimpleContact','comment','2.0.2','Languages Added (Czech, Turkish)','2019-11-24 23:41:20'),
	(311,'Zainab.SimpleContact','comment','2.0.3','Language Added (French), fixed punctuation','2019-11-24 23:41:20'),
	(312,'Spot.UserPermissions','script','1.0.1','create_tables.php','2019-11-24 23:41:49'),
	(313,'Spot.UserPermissions','comment','1.0.1','Development version','2019-11-24 23:41:49'),
	(314,'Spot.UserPermissions','comment','1.0.2','!!! Various optimization changes, this update is not compatible with previous versions.','2019-11-24 23:41:49'),
	(315,'Spot.UserPermissions','comment','1.0.3','!!! Consolidation of permission functions into a single hasUserPermission() function, other various changes.','2019-11-24 23:41:49'),
	(316,'Spot.UserPermissions','comment','1.1.0','!!! Added requested code field, optimized SQL query and data handling. Changes to permission forms.','2019-11-24 23:41:49'),
	(317,'Spot.UserPermissions','comment','1.1.1','Fixed so that back-end permissions can control the availability of controlling front-end user permissions','2019-11-24 23:41:49'),
	(318,'Spot.TwigExtensions','comment','1.0.1','First version of TwigExtensions','2019-11-24 23:41:55'),
	(319,'Spot.TwigExtensions','comment','1.0.2','Add template_from_string function','2019-11-24 23:41:55'),
	(320,'Spot.TwigExtensions','comment','1.0.3','Fix uppercase, lowercase and ucfirst for UTF-8 characters','2019-11-24 23:41:55'),
	(321,'Spot.TwigExtensions','comment','1.0.4','Add leftpad, rightpad and strpad filters. Cover by unit tests.','2019-11-24 23:41:55'),
	(322,'Spot.TwigExtensions','comment','1.0.5','Add config function (thanks to Sebastian Hilger)','2019-11-24 23:41:55'),
	(323,'Spot.TwigExtensions','comment','1.0.6','Fix localizednumber and localizedcurrency filters (thanks to Vita Zoubek)','2019-11-24 23:41:55'),
	(324,'Spot.TwigExtensions','comment','1.0.7','Add the session() and trans() helper functions (thanks to Sebastian Hilger)','2019-11-24 23:41:55'),
	(325,'Spot.TwigExtensions','comment','1.0.8','Plugin can be installed over Composer.','2019-11-24 23:41:55'),
	(326,'Spot.TwigExtensions','comment','1.0.9','Add var_dump filter and function.','2019-11-24 23:41:55'),
	(327,'Spot.TwigExtensions','comment','1.0.10','Remove pre tag from var_dump','2019-11-24 23:41:55'),
	(328,'Spot.TwigExtensions','comment','1.0.11','Add mailto filter for rendering encrypted email addresses.','2019-11-24 23:41:55'),
	(329,'Spot.TwigExtensions','comment','1.0.12','Add mailto text parameter and rtl filter.','2019-11-24 23:41:55'),
	(330,'Spot.TwigExtensions','comment','1.0.13','Make time_diff translatable.','2019-11-24 23:41:55'),
	(331,'Spot.TwigExtensions','comment','1.0.14','Add pt-br locale for time_diff translation (thanks to Ronaldo Ribeiro de Sousa)','2019-11-24 23:41:55'),
	(332,'Spot.TwigExtensions','comment','1.0.15','Add DE and HU locale (thanks to Szabó Gergő and Sebastian Hilger)','2019-11-24 23:41:55'),
	(333,'Spot.TwigExtensions','comment','1.1.0','Make changes for Laravel 5.5.','2019-11-24 23:41:55'),
	(334,'Spot.TwigExtensions','comment','1.1.1','Add revision filter','2019-11-24 23:41:55'),
	(335,'Spot.TwigExtensions','comment','1.1.2','Add strip_tags filter','2019-11-24 23:41:55'),
	(336,'Spot.TwigExtensions','comment','1.1.3','Add sortbyfield filter to sorting arrays/fields by key.','2019-11-24 23:41:55'),
	(337,'Spot.TwigExtensions','comment','1.2.0','Require PHP 7.0 as minimum version.','2019-11-24 23:41:55'),
	(338,'Spot.TwigExtensions','comment','1.2.1','Add linter and code sniffer for better automatization.','2019-11-24 23:41:55'),
	(339,'Spot.TwigExtensions','comment','1.2.2','Add str_replace filter (thanks to Szabó Gergő)','2019-11-24 23:41:55'),
	(340,'Spot.TwigExtensions','comment','1.2.3','Added an optional css class parameter to mailto function','2019-11-24 23:41:55'),
	(341,'Spot.TwigExtensions','comment','1.2.4','Add sk_SK locale, thanks to Marek Závacký','2019-11-24 23:41:55'),
	(342,'Spot.TwigExtensions','comment','1.2.5','Add env() helper function, thanks to Marek Závacký','2019-11-24 23:41:55'),
	(391,'PanaKour.Backup','script','1.0.1','seed_default_settings.php','2019-11-24 23:49:52'),
	(392,'PanaKour.Backup','comment','1.0.1','First version of backup plugin.','2019-11-24 23:49:52'),
	(393,'PanaKour.Backup','comment','1.0.2','Fixes bug when no backup folder exist','2019-11-24 23:49:52'),
	(394,'PanaKour.Backup','comment','1.0.3','Settings button directly in toolbar of backup list. Fixed monitored backups name','2019-11-24 23:49:52'),
	(395,'PanaKour.Backup','comment','1.0.4','Support Dropbox storage driver','2019-11-24 23:49:52'),
	(396,'PanaKour.Backup','comment','1.0.5','Support Dropbox storage driver (Fix if not configured yet)','2019-11-24 23:49:52'),
	(397,'PanaKour.Backup','comment','1.0.6','Change the backups path to fix 404 error on apache server because of the default .htaccess','2019-11-24 23:49:52'),
	(398,'PanaKour.Backup','comment','1.0.7','Display backup list even if exist only in the old path','2019-11-24 23:49:52'),
	(399,'PanaKour.Backup','comment','1.0.8','Add permissions.','2019-11-24 23:49:52'),
	(400,'PanaKour.Backup','comment','1.0.9','Add option to create backup of whole project independently of settings','2019-11-24 23:49:52'),
	(401,'Kocholes.BarcodeGenerator','comment','1.0.1','Initialize plugin.','2019-11-24 23:50:02'),
	(402,'Kocholes.BarcodeGenerator','comment','1.0.2','Compatibility with latest build (446 at the moment).','2019-11-24 23:50:02'),
	(638,'Spot.Shipment','script','1.0.1','extendUser.php','2019-11-25 00:07:19'),
	(639,'Spot.Shipment','script','1.0.1','changePermissions.php','2019-11-25 00:07:19'),
	(640,'Spot.Shipment','script','1.0.1','changeTranslate.php','2019-11-25 00:07:19'),
	(641,'Spot.Shipment','comment','1.0.1','Initialize plugin.','2019-11-25 00:07:19'),
	(642,'Spot.Shipment','comment','1.0.1','Added user table columns','2019-11-25 00:07:19'),
	(643,'Spot.Shipment','script','1.0.2','builder_table_create_spot_shipment_order.php','2019-11-25 00:07:19'),
	(644,'Spot.Shipment','comment','1.0.2','Created table spot_shipment_order','2019-11-25 00:07:19'),
	(645,'Spot.Shipment','script','1.0.3','builder_table_create_spot_shipment_item.php','2019-11-25 00:07:19'),
	(646,'Spot.Shipment','comment','1.0.3','Created table spot_shipment_item','2019-11-25 00:07:19'),
	(647,'Spot.Shipment','script','1.0.4','builder_table_create_spot_shipment_task.php','2019-11-25 00:07:19'),
	(648,'Spot.Shipment','comment','1.0.4','Created table spot_shipment_task','2019-11-25 00:07:19'),
	(649,'Spot.Shipment','script','1.0.5','builder_table_create_spot_shipment_category.php','2019-11-25 00:07:19'),
	(650,'Spot.Shipment','comment','1.0.5','Created table spot_shipment_category','2019-11-25 00:07:19'),
	(651,'Spot.Shipment','script','1.0.6','builder_table_create_spot_shipment_office.php','2019-11-25 00:07:19'),
	(652,'Spot.Shipment','comment','1.0.6','Created table spot_shipment_office','2019-11-25 00:07:19'),
	(653,'Spot.Shipment','script','1.0.7','builder_table_create_spot_shipment_address.php','2019-11-25 00:07:19'),
	(654,'Spot.Shipment','comment','1.0.7','Created table spot_shipment_address','2019-11-25 00:07:19'),
	(655,'Spot.Shipment','script','1.0.8','builder_table_create_spot_shipment_packaging.php','2019-11-25 00:07:19'),
	(656,'Spot.Shipment','comment','1.0.8','Created table spot_shipment_packaging','2019-11-25 00:07:19'),
	(657,'Spot.Shipment','script','1.0.9','builder_table_create_spot_shipment_courier.php','2019-11-25 00:07:19'),
	(658,'Spot.Shipment','comment','1.0.9','Created table spot_shipment_courier','2019-11-25 00:07:19'),
	(659,'Spot.Shipment','script','1.0.10','builder_table_create_spot_shipment_delivery_time.php','2019-11-25 00:07:19'),
	(660,'Spot.Shipment','comment','1.0.10','Created table spot_shipment_delivery_time','2019-11-25 00:07:19'),
	(661,'Spot.Shipment','script','1.0.11','builder_table_create_spot_shipment_mode.php','2019-11-25 00:07:19'),
	(662,'Spot.Shipment','comment','1.0.11','Created table spot_shipment_mode','2019-11-25 00:07:19'),
	(663,'Spot.Shipment','script','1.0.12','builder_table_create_spot_shipment_status.php','2019-11-25 00:07:20'),
	(664,'Spot.Shipment','comment','1.0.12','Created table spot_shipment_status','2019-11-25 00:07:20'),
	(665,'Spot.Shipment','script','1.0.13','builder_table_create_spot_shipment_activity.php','2019-11-25 00:07:20'),
	(666,'Spot.Shipment','comment','1.0.13','Created table spot_shipment_activity','2019-11-25 00:07:20'),
	(667,'Spot.Shipment','script','1.0.14','builder_table_create_spot_shipment_car.php','2019-11-25 00:07:20'),
	(668,'Spot.Shipment','comment','1.0.14','Created table spot_shipment_car','2019-11-25 00:07:20'),
	(669,'Spot.Shipment','script','1.0.15','builder_table_create_spot_shipment_area.php','2019-11-25 00:07:20'),
	(670,'Spot.Shipment','comment','1.0.15','Created table spot_shipment_area','2019-11-25 00:07:20'),
	(671,'Spot.Shipment','script','1.0.16','builder_table_create_spot_shipment_city.php','2019-11-25 00:07:20'),
	(672,'Spot.Shipment','comment','1.0.16','Created table spot_shipment_city','2019-11-25 00:07:20'),
	(673,'Spot.Shipment','script','1.0.17','builder_table_create_spot_shipment_manifest.php','2019-11-25 00:07:20'),
	(674,'Spot.Shipment','comment','1.0.17','Created table spot_shipment_manifest','2019-11-25 00:07:20'),
	(675,'Spot.Shipment','script','1.0.18','builder_table_create_spot_shipment_fees.php','2019-11-25 00:07:20'),
	(676,'Spot.Shipment','comment','1.0.18','Created table spot_shipment_fees','2019-11-25 00:07:20'),
	(677,'Spot.Shipment','script','1.0.19','builder_table_create_spot_shipment_payment.php','2019-11-25 00:07:20'),
	(678,'Spot.Shipment','comment','1.0.19','Created table spot_shipment_payment','2019-11-25 00:07:20'),
	(679,'Spot.Shipment','script','1.0.20','builder_table_create_spot_shipment_treasury.php','2019-11-25 00:07:20'),
	(680,'Spot.Shipment','comment','1.0.20','Created table spot_shipment_treasury','2019-11-25 00:07:20'),
	(681,'Spot.Shipment','script','1.0.21','builder_table_create_spot_shipment_employee_order.php','2019-11-25 00:07:20'),
	(682,'Spot.Shipment','comment','1.0.21','Created table spot_shipment_employee_order','2019-11-25 00:07:20'),
	(683,'Spot.Shipment','script','1.0.22','builder_table_create_spot_shipment_notes.php','2019-11-25 00:07:20'),
	(684,'Spot.Shipment','comment','1.0.22','Created table spot_shipment_notes','2019-11-25 00:07:20'),
	(685,'Spot.Shipment','script','1.0.23','seed_all_tables.php','2019-11-25 00:07:20'),
	(711,'OFFLINE.CORS','comment','1.0.1','Initial release.','2019-11-25 23:13:47'),
	(712,'OFFLINE.CORS','comment','1.0.2','Fixed backend settings label (thanks to LukeTowers)','2019-11-25 23:13:47'),
	(713,'OFFLINE.CORS','comment','1.0.3','Added support for filesystem configuration file / Added plugin to Packagist (https://packagist.org/packages/offline/oc-cors-plugin)','2019-11-25 23:13:47'),
	(714,'OFFLINE.CORS','comment','1.0.4','Fixed minor bug when running the plugin without custom settings','2019-11-25 23:13:47'),
	(715,'OFFLINE.Speedy','comment','1.0.1','Initial version of Speedy','2019-11-27 10:26:40'),
	(716,'OFFLINE.Speedy','comment','1.0.2','Fixed compatibility issues with builds 420+','2019-11-27 10:26:40'),
	(717,'OFFLINE.Speedy','comment','1.0.3','Added russian translations (thanks to pavalx-ru)','2019-11-27 10:26:40'),
	(718,'OFFLINE.Speedy','comment','1.0.4','Added french translations (thanks to damsfx)','2019-11-27 10:26:40'),
	(719,'OFFLINE.Speedy','comment','1.0.5','Added pt-pt translations (thanks to João Costa)','2019-11-27 10:26:40'),
	(720,'OFFLINE.Speedy','comment','1.0.6','Switched to mod_deflate for gzip compression. Disable gzip compression in the Speedy settings and turn it back on to apply these changes to your installation.','2019-11-27 10:26:40'),
	(722,'RainLab.Builder','comment','1.0.1','Initialize plugin.','2020-01-13 04:40:27'),
	(723,'RainLab.Builder','comment','1.0.2','Fixes the problem with selecting a plugin. Minor localization corrections. Configuration files in the list and form behaviors are now autocomplete.','2020-01-13 04:40:27'),
	(724,'RainLab.Builder','comment','1.0.3','Improved handling of the enum data type.','2020-01-13 04:40:27'),
	(725,'RainLab.Builder','comment','1.0.4','Added user permissions to work with the Builder.','2020-01-13 04:40:27'),
	(726,'RainLab.Builder','comment','1.0.5','Fixed permissions registration.','2020-01-13 04:40:27'),
	(727,'RainLab.Builder','comment','1.0.6','Fixed front-end record ordering in the Record List component.','2020-01-13 04:40:27'),
	(728,'RainLab.Builder','comment','1.0.7','Builder settings are now protected with user permissions. The database table column list is scrollable now. Minor code cleanup.','2020-01-13 04:40:27'),
	(729,'RainLab.Builder','comment','1.0.8','Added the Reorder Controller behavior.','2020-01-13 04:40:27'),
	(730,'RainLab.Builder','comment','1.0.9','Minor API and UI updates.','2020-01-13 04:40:27'),
	(731,'RainLab.Builder','comment','1.0.10','Minor styling update.','2020-01-13 04:40:27'),
	(732,'RainLab.Builder','comment','1.0.11','Fixed a bug where clicking placeholder in a repeater would open Inspector. Fixed a problem with saving forms with repeaters in tabs. Minor style fix.','2020-01-13 04:40:27'),
	(733,'RainLab.Builder','comment','1.0.12','Added support for the Trigger property to the Media Finder widget configuration. Names of form fields and list columns definition files can now contain underscores.','2020-01-13 04:40:27'),
	(734,'RainLab.Builder','comment','1.0.13','Minor styling fix on the database editor.','2020-01-13 04:40:27'),
	(735,'RainLab.Builder','comment','1.0.14','Added support for published_at timestamp field','2020-01-13 04:40:27'),
	(736,'RainLab.Builder','comment','1.0.15','Fixed a bug where saving a localization string in Inspector could cause a JavaScript error. Added support for Timestamps and Soft Deleting for new models.','2020-01-13 04:40:27'),
	(737,'RainLab.Builder','comment','1.0.16','Fixed a bug when saving a form with the Repeater widget in a tab could create invalid fields in the form\'s outside area. Added a check that prevents creating localization strings inside other existing strings.','2020-01-13 04:40:27'),
	(738,'RainLab.Builder','comment','1.0.17','Added support Trigger attribute support for RecordFinder and Repeater form widgets.','2020-01-13 04:40:27'),
	(739,'RainLab.Builder','comment','1.0.18','Fixes a bug where \'::class\' notations in a model class definition could prevent the model from appearing in the Builder model list. Added emptyOption property support to the dropdown form control.','2020-01-13 04:40:27'),
	(740,'RainLab.Builder','comment','1.0.19','Added a feature allowing to add all database columns to a list definition. Added max length validation for database table and column names.','2020-01-13 04:40:27'),
	(741,'RainLab.Builder','comment','1.0.20','Fixes a bug where form the builder could trigger the \"current.hasAttribute is not a function\" error.','2020-01-13 04:40:27'),
	(742,'RainLab.Builder','comment','1.0.21','Back-end navigation sort order updated.','2020-01-13 04:40:27'),
	(743,'RainLab.Builder','comment','1.0.22','Added scopeValue property to the RecordList component.','2020-01-13 04:40:27'),
	(744,'RainLab.Builder','comment','1.0.23','Added support for balloon-selector field type, added Brazilian Portuguese translation, fixed some bugs','2020-01-13 04:40:27'),
	(745,'RainLab.Builder','comment','1.0.24','Added support for tag list field type, added read only toggle for fields. Prevent plugins from using reserved PHP keywords for class names and namespaces','2020-01-13 04:40:27'),
	(746,'RainLab.Builder','comment','1.0.25','Allow editing of migration code in the \"Migration\" popup when saving changes in the database editor.','2020-01-13 04:40:27'),
	(747,'RainLab.Builder','comment','1.0.26','Allow special default values for columns and added new \"Add ID column\" button to database editor.','2020-01-13 04:40:27'),
	(748,'Spot.Shipment','script','1.0.24','builder_table_update_spot_shipment_activity.php','2020-01-13 04:41:13'),
	(749,'Spot.Shipment','comment','1.0.24','Updated table spot_shipment_activity','2020-01-13 04:41:13'),
	(750,'Spot.Shipment','script','1.0.25','builder_table_create_spot_shipment_tracking.php','2020-01-13 04:46:11'),
	(751,'Spot.Shipment','comment','1.0.25','Created table spot_shipment_tracking','2020-01-13 04:46:11');
...
VALUES
	(2,'RainLab.User','1.5.0','2019-11-24 23:38:39',0,0),
	(3,'Vdomah.JWTAuth','1.0.7','2019-11-24 23:38:50',0,0),
	(4,'RainLab.Notify','1.0.2','2019-11-24 23:38:58',0,0),
	(5,'Tiipiik.SmsSender','1.0.4','2019-11-24 23:39:11',0,0),
	(6,'RainLab.Location','1.1.5','2019-11-24 23:39:20',0,0),
	(7,'RainLab.UserPlus','1.1.0','2019-11-24 23:39:29',0,0),
	(8,'Vdomah.Roles','1.2.5','2019-11-24 23:39:38',0,0),
	(9,'RainLab.Translate','1.6.2','2019-11-24 23:39:47',0,0),
	(10,'RainLab.Pages','1.3.1','2019-11-24 23:40:05',0,0),
	(11,'PanaKour.Translate','1.0.1','2019-11-24 23:40:05',0,0),
	(12,'Mey.Breadcrumbs','1.0.10','2019-11-24 23:40:13',0,0),
	(13,'Responsiv.Currency','1.0.4','2019-11-24 23:40:22',0,0),
	(14,'Initbiz.Money','1.0.8','2019-11-24 23:40:32',0,0),
	(15,'Responsiv.Uploader','1.0.1','2019-11-24 23:40:40',0,0),
	(16,'Jacob.Logbook','1.0.3','2019-11-24 23:40:48',0,0),
	(17,'Excodus.TranslateExtended','1.0.7','2019-11-24 23:40:56',0,0),
	(18,'Responsiv.Pay','1.1.1','2019-11-24 23:41:11',0,0),
	(19,'Zainab.SimpleContact','2.0.3','2019-11-24 23:41:20',0,0),
	(20,'Spot.UserPermissions','1.1.1','2019-11-24 23:41:49',0,0),
	(21,'Spot.TwigExtensions','1.2.5','2019-11-24 23:41:55',0,0),
	(23,'PanaKour.Backup','1.0.9','2019-11-24 23:49:52',0,0),
	(24,'Kocholes.BarcodeGenerator','1.0.2','2019-11-24 23:50:02',0,0),
	(30,'Spot.Shipment','1.0.25','2020-01-13 04:46:11',0,0),
	(34,'OFFLINE.CORS','1.0.4','2019-11-25 23:13:47',0,0),
	(35,'OFFLINE.Speedy','1.0.6','2019-11-27 10:26:40',0,0),
	(37,'RainLab.Builder','1.0.26','2020-01-13 04:40:27',0,0);
...
VALUES
	(1,'acme_demo_settings','{\"language\":\"en\",\"timezone_offset\":\"+02:00\",\"dateformat\":\"m\\/d\\/Y\",\"company\":{\"title\":\"Cargo Courier System\",\"charset\":\"utf-8\",\"description\":\"We ship anything\",\"keywords\":\"courier system,shipping management,cargo,spotlayer project,spot shipping,laravel shipping system\",\"primary_email\":\"info@spotlayer.com\",\"tax_number\":\"-\",\"company_phone\":\"57828415421\",\"company_phone_2\":\"57828415422\",\"company_phone_3\":\"57828415423\",\"facebook\":\"https:\\/\\/www.facebook.com\\/SpotlayerInc\",\"twitter\":\"https:\\/\\/twitter.com\\/spotlayer\",\"instagram\":\"http:\\/\\/instagram.com\\/spotlayer\\/\",\"address\":\"I Avenue, Hesperia, California, USA\",\"lat\":\"34.4280718\",\"lng\":\"-117.28109259999997\",\"county\":\"\",\"city\":\"Hesperia\",\"state\":\"California\",\"postal_code\":\"92345\",\"country\":\"United States\"},\"tracking\":{\"prefix_order\":\"AWB\",\"numbers_order\":\"5\",\"prefix_container\":\"CON\",\"numbers_container\":\"5\",\"default_deliverytime\":\"1\",\"default_status\":\"1\",\"default_tracking_id\":\"3\"},\"taxes\":{\"percent\":\"0\",\"insurance\":\"0\"},\"notifications\":{\"live\":1,\"provider\":\"pusher\",\"pusher\":{\"app_id\":\"865316\",\"key\":\"f528799c3805931b4fa0\",\"secret\":\"f0d7684fd5bb96aa0e33\",\"cluster\":\"eu\"},\"responsibility\":{\"new_shipments\":[\"1\"],\"new_note\":[\"1\",\"6\",\"7\",\"8\"],\"update_shipment\":[\"1\"],\"approved_shipment\":[\"1\",\"6\",\"7\"],\"refused_shipment\":[\"1\",\"6\",\"7\"],\"postponed_shipment\":[\"1\",\"6\",\"7\"],\"transfered_shipment\":[\"1\",\"6\",\"7\"],\"assign_shipment\":[\"1\",\"6\",\"7\",\"8\"],\"driver_received\":[\"1\",\"6\",\"7\"],\"discards_request\":[\"1\",\"6\",\"7\"],\"received\":[\"1\",\"6\",\"7\"],\"manifest_assigned\":[\"1\"],\"stock_saved\":[\"1\"],\"returned\":[\"1\",\"6\",\"7\"],\"delivered\":[\"1\",\"6\",\"7\"],\"return_discards\":[\"1\",\"6\",\"7\"]}},\"fees\":{\"delivery_cost\":\"30.00\",\"pickup_cost\":\"10.00\",\"delivery_cost_back_sender\":\"10.00\",\"delivery_cost_back_receiver\":\"10.00\"},\"invoice\":{\"terms\":\"ACCEPTED: This invoice complies with the requirements of article 774 of the commercial code modified by law 1231 of 2008 and therefore constitutes a security title. The person who signs declares to be duly authorized by the buyer to do so. The cancellation after the due date causes default interest at the current legal maximum rate.\",\"signing_company\":\"Company\",\"signing_customer\":\"Customer\"},\"google\":{\"map\":{\"key\":\"AIzaSyCjN-FapLWoOHL6QOnVcwjFmesRdCyUiAc\"},\"recaptcha\":{\"key\":\"6Ld1i7wUAAAAAF7slYbtMkjKa792itRVrLOuno7M\"}}}'),
...
# Dump of table tiipiik_smssender_message_histories
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tiipiik_smssender_message_histories`;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `activation_code`, `persist_code`, `reset_password_code`, `permissions`, `is_activated`, `activated_at`, `last_login`, `created_at`, `updated_at`, `username`, `surname`, `deleted_at`, `last_seen`, `is_guest`, `is_superuser`, `phone`, `company`, `street_addr`, `city`, `zip`, `state_id`, `country_id`, `mobile`, `role_id`, `city_id`, `area_id`, `manager`, `places`, `gender`, `driver`, `office`, `language`)
VALUES
	(1,'Manager','support@spotlayer.com','$2y$10$jQSJ1ExYUxa.JMUPkKWjce/Q5TBazH4hNzdcfqBiK5uX.Oarnd.XO',NULL,'$2y$10$rbeOI9qMQKw80nD2Jar4h.c4gzXojCpw0FED.BwSTDfNAmsUJ2m3a',NULL,NULL,1,'2019-11-24 11:42:01','2020-01-14 21:06:15','2019-11-24 11:42:01','2020-01-14 21:06:15','admin','Courier Administration',NULL,'2020-01-14 21:06:18',0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
# Dump of table vdomah_roles_permissions
# ------------------------------------------------------------

DROP TABLE IF EXISTS `vdomah_roles_permissions`;
...
# Dump of table vdomah_roles_roles
# ------------------------------------------------------------

DROP TABLE IF EXISTS `vdomah_roles_roles`;
...
LOCK TABLES `vdomah_roles_roles` WRITE;
/*!40000 ALTER TABLE `vdomah_roles_roles` DISABLE KEYS */;

INSERT INTO `vdomah_roles_roles` (`id`, `name`, `parent_id`, `code`)
VALUES
...
/*!40000 ALTER TABLE `vdomah_roles_roles` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table zainab_simplecontact_contact
# ------------------------------------------------------------
